...
if __name__ == "__main__":
    ...
    xml = arm.mjcf_model.to_xml_string()
    ...
    # eef_mount = arm.mjcf_model.find('geom','2_G9')
    # eef_mount.add("joint", name="eef_joint",)
    full_arm = arm_mjcf.attach(gripper_mjcf)
    ...
    f = open(_BELLOWS_MUJOCO_ROOT +"/bellows_arm_hand.mjcf", "w")
    f.write(xml)
    f.close()
